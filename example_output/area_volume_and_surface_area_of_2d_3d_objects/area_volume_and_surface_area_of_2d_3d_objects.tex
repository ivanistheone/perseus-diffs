...
\begin{align*} 10.1\text{ ft}\times5&=50.5\text{ ft}\\\\6\text{ ft}\times2&=12\text{ ft}\\\\10\text{ ft}\times1&=10\text{ ft}\end{align*}
...
\begin{align*} \text{V} &= \text{length}\cdot\text{width}\cdot\text{height}\\&=50.5\times12\times10\\&=\blue{6060}\text{ ft}^3\end{align*}

\paragraph{Hint 4}Let's find  $V$ of a crate in cubic feet:

\begin{align*} \text{V} &= \text{length}\cdot\text{width}\cdot\text{height}\\&=10.1\times6\times10\\&=\pink{606}\text{ ft}^3\end{align*}

\paragraph{Hint 5}Now, let's divide the volume of the boxcar by the volume of a crate to find how many crates:

\begin{align*}\ &=\blue{6060}\div\pink{606}\\&=\green{10}\end{align*}
...
\textbf{Version:} 5ad75d6d.. 2013-10-14
\smallskip\hrule
...
**How much will Abuto pay for wall-to-wall carpet for his living room?**
\includegraphics[scale=\shrinkfactor]{figures/9b1e5c4a0a1124465ed46125df08ae907b12b004.png}

\paragraph{Ans} $\$$ [[? input-number 1]]  57

\paragraph{Hint 1}Abuto's living room has $3$ rectangular areas and $1$ triangular area to cover with carpet. Let's find the total area of the living room floor in square feet to find how much carpet Abuto needs.
...
\begin{align*}  
&= 0.8\times1 +0.8\times0.4+0.6\times1.1+ 0.5\times0.6\times\red{0.4}\\\\&=0.8+0.32+0.66+0.12\\\\
&= \purple{1.9} \text{ m}^2\end{align*}
...
\begin{align*} &= \green{30}\times\purple{1.9}\\&=\$\blue{ 57}\end{align*}
...
\textbf{Version:} b75c2b50.. 2013-10-14
\smallskip\hrule
...
\begin{align*}  
&= 2.4\times1.2 +2.4^2+1.2\times3.0+ 0.5\times1.2\times\red{1.2}\\\\&=2.88+5.76+3.6+0.72\\\\
...
\noindent
\textbf{Tags:} {\footnotesize Images with English text,  Area, volume, and surface area of 2d and 3d objects, CC.7.G.B.6}\\
\textbf{Version:} 4ff39c7b.. 2013-10-11
\smallskip\hrule
...
\noindent
The company Sweet as Pie has $500$ mile-high pumpkin pies to make for Thanksgiving. They package their pies each in a folded box made out of cardboard. The closed box is a cube with side lengths $9\text{ in}$. There are $7$ rectangular tabs that wrap around the edges to make sure the pies stay fresh. The tabs are $9\text{ in}$ by $2\text{ in}$ each.

**In square inches what is the minimum amount of cardboard Sweet as Pie needs to package all $500$ pumpkin pies individually? (Assume there is no wasted cardboard.)**
...
\begin{align*} SA &= \green{6}\times\blue{9}\times\blue{9}\\
&= 486\text{ in}^2\end{align*}

There are $\purple7$ rectangular tabs $\blue{9}\text{ in}$ by $\pink{2}\text{ in}$:
 
\begin{align*} SA &= \purple{7}\times\blue{9}\times\pink{2}\\
&= 126\text{ in}^2\end{align*}

Let’s sum together all the surface areas to find the total surface area of one box: 

\begin{align*} SA &= 486 + 126\\
&= 612\text{ in}^2\end{align*}

\paragraph{Hint 3}Let's multiply the total area by $\gray{500}$ boxes to find the amount of cardboard:

\begin{align*} SA &= \gray{500}\times612\\&= \red{306000}\text{ in}^2\end{align*}
...
\noindent
\textbf{Tags:} {\footnotesize Image needs attribution,  Area, volume, and surface area of 2d and 3d objects, CC.7.G.B.6}\\
\textbf{Version:} 85286b7a.. 2013-10-14
\smallskip\hrule
...
\noindent
Molly wants to know the volume of her gold ring in cubic centimeters. She gets a rectangular glass with a base $3\text{ cm}$ by $2\text{ cm}$ and fills the glass $3.1 \text{ cm}$ high with water. Molly drops her gold ring in the glass and measures the new height of the water to be $3.7\text{ cm}$. 
...
\paragraph{Hint 2}The length $\green3\text{ cm}$ and width $\purple2\text{ cm}$ of the water in the rectangular glass does not change, but the height does change. 
...
\noindent
\textbf{Tags:} {\footnotesize Image needs attribution,  Area, volume, and surface area of 2d and 3d objects, CC.7.G.B.6}\\
\textbf{Version:} 3c136df5.. 2013-10-15
\smallskip\hrule
...
\noindent
A crew is excavating a construction site to build a new swimming pool. The crew fills the box of a dump truck to the top with dirt. The box is $40\text{ ft}$ long, $25\text{ ft}$ wide, and $20\text{ ft}$ high. In transport to the dump site, the volume of the soil decreases $15\%$ as it settles in the box. 
...
\paragraph{Hint 1}The length and width of the soil in the box does not change, but the height does change. Only the height of the soil decreases $15\%$. 

In other words, the soil is $\green{85}\%$ of its original height at the dump site, since $100\%-15\%=\green{85}\%$.
...
\begin{align*} h &= \green{0.85}\cdot\purple{20}\\&= \pink{17}\text{ ft}\end{align*}
...
\begin{align*} \text{V} &= \text{length}\cdot\text{width}\cdot\text{height}\\
&= 40\cdot25\cdot\pink{17}\\
&= \blue{17000}\text{ ft}^3\end{align*}

\paragraph{Hint 4}The volume of the dirt at the dump site is $\blue{17000}\text{ ft}^3$.
...
\noindent
\textbf{Tags:} {\footnotesize Image needs attribution,  Area, volume, and surface area of 2d and 3d objects, CC.7.G.B.6}\\
\textbf{Version:} d6fed02e.. 2013-10-14
\smallskip\hrule
...
\noindent
Molly made each of her $12$ girlfriends a pair of earrings. To wrap the pairs individually, she creates a simple cardboard gift box to fold into a pyramid. The base is a square with side lengths $10\text{ in}$. The sides are $4$ equilateral triangles with side lengths $10\text{ in}$ and height $h$. The height $h$ is equal to $8\dfrac{2}{3}\text{ in}$. 
...
Area of a triangle is equal to one half its base times its height $h$. There are $\purple4$ triangles with a base of $\blue{10}\text{ in}$ and height of $\pink{8\dfrac{2}{3}}\text{ in}$:
...
\noindent
\textbf{Tags:} {\footnotesize Image needs attribution,  Area, volume, and surface area of 2d and 3d objects, CC.7.G.B.6}\\
\textbf{Version:} 43de7f04.. 2013-10-14
\smallskip\hrule
...
\textbf{Version:} 885cd722.. 2013-10-12
\smallskip\hrule
...
%    http://www.farmersagent.com/Assets/Agents/tbrown8/Images/e5db961622b94a55a7cbe0a2b2c1a6c7_AdPanel.gif \
