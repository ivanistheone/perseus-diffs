% Mon 19 Aug 2013 10:08:29 EDT  with corrections
...
\noindent
A cyclist is riding downhill on a smooth road which starts at the top of a mountain and descends towards the ocean.
His height $h$ above the ocean level is a function of the distance $d$ from the top of the mountain.
The top of the mountain has a height of $h=1200\text{ m}$. For each $1000\text{ m}$ of distance traveled, 
his height $h$ decreases by $200\text{ m}$.

**Find the equation that describes $h$ as a function of $d$.**

\paragraph{Ans}The equation that describes the height $h$ as a function of the distance $d$ is   
[[? expression 1]] h = 1200 - 0.2d

\paragraph{Hint 1}We're given the description of a real-world situation and asked to find the mathematical equation that describes it. We want to find the equation that describes the height of the cyclist $\blue{h}$ as a function of the distance $d$ traveled from the top of the mountain.

\paragraph{Hint 2}The initial height of the cyclist when he starts at the top of the mountain is $\green{1200}\text{ m}$. This height corresponds to a distance of $\red{d}=0\text{ m}$ from the starting point.

\paragraph{Hint 3}Now let's find the rate of change of the height of the cyclist as he travels down the mountain. We are told that for each $\red{1000}\text{ m}$ of distance traveled, 
his height $\blue{h}$ decreases by $\blue{200}\text{ m}$. We calculate the rate of change of the height function by dividing the  change in the height by the change in the distance:
...
\paragraph{Hint 4}The equation that describes the height $\blue{h}$ of the cyclist as a function of the distance $\red{d}$ is the following:
...
\paragraph{Hint 5}The equation that describes $h$ as a function of $d$ is $h= 1200-0.2d$.
...
\textbf{Version:} 145f0668.. 2013-08-19
\smallskip\hrule
...
**Write the function that represents the price $P\:$  for $h$ hours of bike rental.**    

\paragraph{Ans}The price of the rental $P\:$ as a function of the number of hours $h$ is   
[[? expression 1]]  P = 10+4*h

\paragraph{Hint 1}Let's use the information provided to figure out the function that describes the price $\blue{P}\:$ of the bike rental.

The bike rental includes a fixed charge of $\$\green{10}$. This is the base amount David has to pay to rent out the bicycle.

To find the total price, we have to add the base price to the hourly charge of $\$\purple{4}$ per hour. If David rents the bike for $\red{h}$ hours, the hourly charge will be $\purple{4}\red{h}$ dollars.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 70b4748f.. 2013-08-19
\smallskip\hrule
...
Assume that Arlo wants to spend the *entire* budget at this farm. **Write an equation that describes the  number of pepper plants $p$ as a function of the  number of tomato plants $t$ that Arlo can buy.**

\paragraph{Ans}The equation that describes the number of pepper plants $p$ as a function of the number of tomato plants $t$ is
 [[? expression 1]] p = 40 - (3/2)*t

\paragraph{Hint 1}We're trying to find the equation that relates the number of pepper plants $\green{p}$ and the number of tomato plants $\red{t}$ that Arlo can buy for *exactly* $\$80$.
...
Since we know Arlo wants to spend exactly $\$80$, the equation that describes the relationship between the number of pepper and tomato plants he can buy is
...
\paragraph{Hint 4}**The equations that describes $p$ as a function of $t$ is $p = 40 -\frac{3}{2}t$.**
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 688e2a6c.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes the total costs $C$ as a function of the number of bicycles produced $x$?**

\paragraph{Ans}The equation that describes $C$ as a function of $x$ is  
 [[? expression 1]] C=3000 + 100x

\paragraph{Hint 1}We're trying to find the equation that corresponds to the operating costs $\blue{C}$ of Jane's company as a function of the number of bicycles produced $\red{x}$.
We know the fixed costs are $\$\green{3000}$ per month. Additionally, there is a production cost of $\$\purple{100}$ per bicycle.

\paragraph{Hint 2}The *fixed costs* of a company are the costs that are present even when Jane's company does not produce any bicycles $\red{x}=0$. We know that each month Jane has to pay $\green{3000}$ dollars for rent and utilities and that this number does not depend on the number of bicycles produced.
...
\paragraph{Hint 5}Note that the total costs of the company are described by a linear equation of the form $\blue{C}=\purple{m}\red{x}+\green{b}$, where the number $\purple{m}$ corresponds to the *unit cost of production*, and $\green{b}$ is the *initial value* of the costs function.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} f50ded60.. 2013-08-19
\smallskip\hrule
...
**Find the equation that represents Jessica's monthly salary $S$ as a function of the number of sales $n$.**

\paragraph{Ans}The equation that describes $S$ as a function of $n$ is   
[[? expression 1]] S= 2000+100*n

\paragraph{Hint 1}We are told Jessica's salary $\blue{S}$ increases by $\$\purple{100}$ for each sale she makes. Also, we know that she receives a base amount of $\$\green{2000}$.  Let's see how we can use the information provided to figure out the function that describes Jessica's monthly salary.
...
\paragraph{Hint 4}The equation that describes $S$ as a function of $n$ is $S= 2000+100n$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 2595c11c.. 2013-08-19
\smallskip\hrule
...
\noindent
Monica manages a content company that specializes in producing news articles on scientific topics.
...
**Write the equation that describes the total number of articles produced by the company $N$,
as a function of the number of contractors hired $n$.**

\paragraph{Ans}The equation that describes the number of articles  produced $N$ as a function of the number of contractors $n$ is   
[[? expression 1]] N = 100 + 5n

\paragraph{Hint 1}Let's use the information provided to figure out how many articles the content company produces in total.
...
\paragraph{Hint 4}The equation that describes $N$ as a function of $n$ is $N= 100+5n$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 3d21142f.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes $s$ as a function of $n$?**

\paragraph{Ans}The equation that describes the savings $s$ remaining after Frida buys $n$ ice cream cones is 
...
We want to find the equation that describes Frida's saved money $s$ as a function of the number of ice cream cones she buys. 
...
\paragraph{Hint 4}The equation that describes $s$ as a function of $n$ is $s= 10-1.5n$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 0b8908be.. 2013-08-19
\smallskip\hrule
...
\paragraph{Ans}The equation that describes the number of pepper plants $p$ as a function of the number of tomato plants $t$ is
 [[? expression 1]] p = 50- 2t

\paragraph{Hint 1}We're trying to find an equation that relates the number of pepper plants $\green{p}$ and the number of tomato plants $\red{t}$ that Arlo can buy for *exactly* $\$100$.

\paragraph{Hint 2}The price for each pepper plant is $\$2$, so the cost of $\green{p}$ pepper plants is $2\green{p}$ dollars.
The price of $\red{t}$ tomato plants is $4\red{t}$ dollars.
The total budget for purchasing the plants is $\$100$.

Since we know Arlo wants to spend exactly $\$100$, the equation that describes the relationship between the number of pepper and tomato plants he can buy is
...
\paragraph{Hint 4}**The equations that describes $p$ as a function of $t$ is $p = 50 -2t$.**
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 1dd8402a.. 2013-08-19
\smallskip\hrule
...
To find the total price, we have to add the base price to the hourly charge of $\$\purple{5}$ per hour. If Anton rents the bike for $\red{h}$ hours, the hourly charge will be $\purple{5}\red{h}$ dollars.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} aed89317.. 2013-08-19
\smallskip\hrule
...
**Find the equation that describes $L$ as a function of $x$.**

\paragraph{Ans}The equation that describes the money remaining for Eugene to pay back $L$ as a function of the time $x$ in weeks is  
[[? expression 1]] L = 100 -10*x

\paragraph{Hint 1}We're looking for the equation of the function that describes the amount of money $\blue{L}$ remaining  for Eugene to pay back to his friend as a function of the time $\red{x}$ measured in weeks.
...
\begin{align*}
\quad \blue{L} 
 &= \green{100}  \purple{-10}\red{x}.
\end{align*}

Note that the loan remaining $\blue{L}$ is described by a *linear equation* $\blue{L}=\purple{m}\cdot\red{x}  + \green{b}$. The initial value $\green{b}=\green{100}$ represents the amount Eugene owes to his friend when $\red{x}=\red{0}$. The rate of change of the function is $\purple{m}=\purple{-10}$ because Eugene pays back to his friend $\$\purple{10}$ each week.

\paragraph{Hint 3}The equation that describes the money remaining for Eugene to pay back $L$ as a function of the time $x$ in weeks is  $L = 100 - 10x$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 8d5f3b60.. 2013-08-19
\smallskip\hrule
...
\noindent
The manager of an airline company wants to calculate how many mechanics she needs to hire to maintain the company's fleet of airplanes. 
...
**Find the equation that describes $M$ as a function of $n$.**

\paragraph{Ans}The equation that describes the number of mechanics $M$ required to maintain a fleet of $n$ planes is   
[[? expression 1]] M = 20 + 5*n

\paragraph{Hint 1}Let's use the information provided to figure out the function that describes how the number of mechanics the airline needs to hire $\blue{M}$  depends on the number of airplanes $\red{n}$ in the fleet.
...
\paragraph{Hint 5}The equation that describes the number of mechanics $M$ required to maintain a fleet of $n$ planes is $M = 20 + 5n$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 332cdcaa.. 2013-08-19
\smallskip\hrule
...
A cyclist is riding downhill on a smooth road which starts at the top of a mountain and descends towards the ocean.
His height $h$ above the ocean level is a function of the distance $d$ from the top of the mountain.
The top of the mountain has a height of $900\text{ m}$. For each $1000\text{ m}$ of distance traveled, 
...
\paragraph{Hint 2}The initial height of the cyclist when he starts at the top of the mountain is $\green{900}\text{ m}$. This height corresponds to a distance of $\red{d}=0\text{ m}$ from the starting point.

\paragraph{Hint 3}Now let's find the rate of change of the height of the cyclist as he travels down the mountain. We are told that for each $\red{1000}\text{ m}$ of distance traveled, 
his height $\blue{h}$ decreases by $\blue{300}\text{ m}$. We calculate the rate of change of the height function by dividing the change in the height by the change in the distance:
...
\paragraph{Hint 5}The equation that describes $h$ as a function of $d$ is $h= 900-0.3d$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 16cf725c.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes the cost $C$ of the visit as a function of the number $n$ of cavities?**
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 06d26cae.. 2013-08-19
\smallskip\hrule
...
**Find the equation that describes $S$ as a function of $n$.**

\paragraph{Ans}The equation that describes $S$ as a function of $n$ is   
[[? expression 1]] S= 500+5*n

\paragraph{Hint 1}We are told Martha's salary $\blue{S}$ increases by $\$\purple{5}$ for each book she sells. Also, we know that she receives a base amount of $\$\green{500}$.  Let's see how we can use the information provided to figure out the function that describes Martha's monthly salary.
...
\paragraph{Hint 4}The equation that describes $S$ as a function of $n$ is $S= 500+5n$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 47a1e4c5.. 2013-08-19
\smallskip\hrule
...
**Find the equation that describes $y$ as a function of $x$.**

\paragraph{Ans}The equation that describes the money remaining for Ron to pay back $y$ as a function of the time $x$ in weeks is  
[[? expression 1]] y = 200 -20*x

\paragraph{Hint 1}We're looking for the equation of the function that describes the amount of money $\blue{y}$ remaining  for Ron to pay back to his friend as a function of the time $\red{x}$ measured in weeks.
...
\paragraph{Hint 3}The equation that describes the money remaining for Ron to pay back $y$ as a function of the time $x$ in weeks is  $y = 200 - 20x$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} 09a2dd62.. 2013-08-19
\smallskip\hrule
...
**Find the equation that describes the quantity of flour $f$ required as a function of the number of muffins $n$.**

\paragraph{Ans}The amount of flour $f$ (in $\text{ml}$) required for $n$ muffins is described by the equation 
[[? expression 1]] f = 40*n

\paragraph{Hint 1}We're given the information about a muffin recipe, and asked to find an equation that describes it. 
...
\paragraph{Hint 3}Thus, the function that describes the amount of flour $\blue{f}$ required for $\red{n}$ muffins is described by the equation  
...
\paragraph{Hint 4}The equation that describes $f$ as a function of $n$ is $f= 40n$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.1}\\
\textbf{Version:} d7a6232d.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes the monthly bill  $B$ as a function of the number of minutes $x$?** 

\paragraph{Ans}The equation that describes $B$ as a function of $x$ is [[? expression 1]] B =5 + 0.20*x

\paragraph{Hint 1}We want to find the equation that corresponds to the monthly bill $\blue{B}$ as a function of the number of minutes of conversation $\red{x}$. We can look at the values in the table to figure out the equation of the function.
...
\paragraph{Hint 3}So can we figure out the function that describes the monthly bill now? 
...
\textbf{Version:} b2eb82e5.. 2013-08-19
\smallskip\hrule
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.2}\\
\textbf{Version:} 5fefa89a.. 2013-08-19
\smallskip\hrule
...
**Find the equation that describes Kang's monthly salary $S$ as a function of the number of sales $n$.**

\paragraph{Ans}The equation that describes Kang's salary $S$ as a function of the number of sales $n$ is   
[[? expression 1]] S= 1000+100*n

\paragraph{Hint 1}We're shown a table of values that describes how Kang's monthly salary $\blue{S}$ depends on the number of sales $\red{n}$. Let's use the information from the table to figure out the equation that represents $\blue{S}$ as a function of $\red{n}$.
...
\paragraph{Hint 6}The equation that describes Kang's salary $S$ as a function of the number of sales $n$ is $S = 1000+100n$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.2}\\
\textbf{Version:} 0ce8c80c.. 2013-08-19
\smallskip\hrule
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.2}\\
\textbf{Version:} cefdfe39.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes the costs $C$ as a function of the number of bicycles produced $x$?**
...
These are called the *fixed* costs of the company.
...
\paragraph{Hint 5}Note that the total costs of the company are described by a linear equation of the form $\blue{C}=\purple{m}\red{x}+\green{b}$, where the number $\purple{m}=\purple{100}$ corresponds to the *unit cost of production*, and $\green{b}=\green{3000}$ is the *initial value* of the costs function.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.2}\\
\textbf{Version:} 4d6a55d2.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes the cost $C$ of the visit as a function of the number of cavities $n$?**
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.2}\\
\textbf{Version:} 495bf1ad.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes the price $P\:$ as a function of the number of emails $n$?** 

\paragraph{Ans}The equation that describes $P\:$ as a function of $n$ is [[? expression 1]] P =10 + 0.01*n

\paragraph{Hint 1}We want to find the equation that corresponds to the monthly price $\blue{P}\:$ as a function of the number of emails sent $\red{n}$. We can look at the values if the table to figure out the equation of the function.
...
This change in the price is consistent with the rate of $\purple{m}=\purple{\frac{1}{100}}=\purple{0.01}$ dollars per email:
...
\paragraph{Hint 5}The equation that describes $P\:$ as a function of $n$ is $P= \frac{1}{100}n + 10$, which is the same as $P= 0.01n + 10$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.2}\\
\textbf{Version:} fc863ea2.. 2013-08-19
\smallskip\hrule
...
\paragraph{Ans}The equation that describes $y$ as a function of $x$ is 
[[? expression 1]] y = 2x+4

\paragraph{Hint 1}We are shown the graph of a function, and we want to find the equation that corresponds to this graph. In other words, we are looking for the equation that describes $\blue{y}$ as a function of $\red{x}$.

Observe that the slope of the graph is equal to $\purple{2}$ and its $y$-intercept is $\green{4}$.
Let's use this information to figure out the equation that corresponds to this graph.
...
Also when $\red{x}$ changes from $\red{1}$ to $\red{2}$, $\blue{y}$ changes from $\blue{6}$ to $\blue{8}$. The change in $\blue{y}$ is equal to $\purple{2}$ times the change in $\red{x}$.

Now that we know the initial value of the function and its rate of change we can write the equation that describes $\blue{y}$ as a function of $\red{x}$
...
\paragraph{Hint 5}The equation that describes $y$ as a function of $x$ is $y = 2x + 4$.
...
\textbf{Version:} 773efde9.. 2013-08-19
\smallskip\hrule
...
**Find the equation that describes Sean's monthly salary $S$ as a function of the number of sales $n$.**

\paragraph{Ans}The equation that describes Sean's salary $S$ as a function of the number of sales $n$ is  
[[? expression 1]] S= 1000+100*n

\paragraph{Hint 1}We're shown the graph of the function that describes how Sean's monthly salary $\blue{S}$ depends on the number of sales $\red{n}$. Let's use the information from the graph to figure out the equation that represents $\blue{S}$ as a function of $\red{n}$.
...
The graph of the function $\blue{S}=\green{1000} + \purple{100}\red{n}$ is a *line* that passes through the point $(\red{0},\blue{1000})$ and has slope equal to $\purple{100}$. We can understand the function that describes Sean's salary either through its equation or through its graph.

\paragraph{Hint 6}The equation that describes Sean's salary $S$ as a function of the number of sales $n$ is  $S = 1000+100n$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.3}\\
\textbf{Version:} dafe08ad.. 2013-08-19
\smallskip\hrule
...
**Write the equation that describes Jimmy's profit $P\:$ as a function of the number $n$ of hot dogs sold.**

\paragraph{Ans}The equation that describes Jimmy's profit $P$ as a function of the number of hot dogs sold $n$ is   
...
The graph of the function $\blue{P}=\purple{1}\red{n} \green{-8}$ is a *line* that passes through the point $(\red{0},\blue{-8})$ and has slope equal to $\purple{1}$. We can understand the function that describes Jimmy's profit either through its equation or through its graph.

\paragraph{Hint 6}The equation that describes Jimmy's profit $P$ as a function of the number of hot dogs sold $n$ is  $P = 1\cdot n - 8$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.3}\\
\textbf{Version:} 8471638c.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes $P$ as a function of $n$?**

\paragraph{Ans}The equation that describes Kristina's profit $P$ as a function of the number of tickets $n$ is 
[[? expression 1]] P = 20*n  - 2000

\paragraph{Hint 1}The graph shows how the profit $\blue{P}\:$ varies as a function of the number of tickets sold $\red{n}$. Let's use the information from the graph to figure out the equation that describes $\blue{P}\:$ as a function of $\red{n}$.
...
The rate of change $\purple{m}=\purple{20}$ corresponds to the price $\$\purple{20}$ per ticket, and the initial value $\green{b=-2000}$ corresponds to Kristina's initial investment of $\$\green{2000}$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.3}\\
\textbf{Version:} 3800680d.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes $E$ as a function of $n$?**

\paragraph{Ans}The equation that describes Jeff's earnings $E$ as a function of the number of clients $n$ is 
 [[? expression 1]] E = 70 + 10*n

\paragraph{Hint 1}We're looking for the equation that corresponds to the graph. We want to find the function that describes how Jeff's daily earnings $\blue{E}$ depends on the number of clients he serves $\red{n}$.
...
\paragraph{Hint 4}The equation that describes Jeff's earnings $E$ (in dollars) as a function of the number of clients $n$ is $E = 70 + 10n$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.3}\\
\textbf{Version:} 9d66be47.. 2013-08-19
\smallskip\hrule
...
\paragraph{Ans}The equation that describes $x$ as a function of $t$ is 
...
\paragraph{Hint 4}We can now combine the information about the initial value and the rate of change to obtain the equation that describes Covi's position as a function of time:
...
\paragraph{Hint 5}The equation that describes $x$ as a function of $t$ is  $x = 100t - 200$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.3}\\
\textbf{Version:} 78a03650.. 2013-08-19
\smallskip\hrule
...
**What is the equation that describes the file size $f$ as a function of $t$?**

\paragraph{Ans}The equation that describes the growing file size $f$ (in $\text{MB}$) as a function of the time $t$ (in minutes) is 
[[? expression 1]] f = 10*t

\paragraph{Hint 1}We’re looking for the equation that corresponds to the graph of the function.  We want to find the equation that describes how the file size $\blue{f}$ grows with time $\red{t}$. 
...
\paragraph{Hint 5}The equation that describes the growing file size $f$ (in $\text{MB}$) as a function of the time $t$ (in minutes) is $f = 10t$.
...
\noindent
\textbf{Tags:} {\footnotesize CC.8.F.B.4, SB.8.1.F.1.CR, Constructing linear functions.3}\\
\textbf{Version:} bb9fc9ad.. 2013-08-19
\smallskip\hrule
