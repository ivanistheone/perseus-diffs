...
\paragraph{Hint 1}\DIFdelbegin \DIFdel{A triangle is a plane figure with $3$ straight sides and $3$ angles. Can we satisfy the definition given the conditions? }\DIFdelend Let's \DIFdelbegin \DIFdel{try to draw }\DIFdelend \DIFaddbegin \DIFadd{draw an example of }\DIFaddend a triangle where the side length is known between $2$ angles. \DIFdelbegin 
\paragraph{\DIFdel{Hint 2}}\addtocounter{paragraph}{-1}\DIFdel{The $3$ angles in a triangle always sum to $180^\circ$. Because we know the measure of $2$ angles, we can find the measure of the third angle.
}
\paragraph{\DIFdel{Hint 3}}\addtocounter{paragraph}{-1}\DIFdelend Let's \DIFdelbegin \DIFdel{draw any triangle where we know the side length between $2$ known angles. For example, let's }\DIFdelend look at when a side of length $5$ is between \DIFdelbegin \DIFdel{$2$ equal angles }\DIFdelend \DIFaddbegin \DIFadd{a pair of }\DIFaddend $75^\circ$ \DIFdelbegin \DIFdel{and $75^\circ$.
The other $2$ sides must be equal and }\DIFdelend \DIFaddbegin \DIFadd{angles.
}

\paragraph{\DIFadd{Hint 2}}\DIFadd{The other two sides can be drawn at $75^\circ$ angles  and are equal in length. The sides }\DIFaddend meet at a $30^\circ$ angle \DIFaddbegin \DIFadd{to complete the triangle}\DIFaddend . 
...
\paragraph{Hint \DIFdelbegin \DIFdel{4}\DIFdelend \DIFaddbegin \DIFadd{3}\DIFaddend }If  the side length is known between two known angles, only one triangle can be drawn.
...
\textbf{Version:} \DIFdelbegin \DIFdel{d920ceb5}\DIFdelend \DIFaddbegin \DIFadd{549fc212}\DIFaddend .. 2013-10-18
\smallskip\hrule
...
\paragraph{Hint 1}\DIFdelbegin \DIFdel{Without knowing }\DIFdelend \DIFaddbegin \DIFadd{We do not know the measure of }\DIFaddend at least $1$ angle \DIFdelbegin \DIFdel{measure, we }\DIFdelend \DIFaddbegin \DIFadd{or length of the third side. We }\DIFaddend cannot create a unique triangle with only one shape and size.
...
\paragraph{Hint 3}If we only know \DIFdelbegin \DIFdel{$1$ angle and $1$ side length}\DIFdelend \DIFaddbegin \DIFadd{$2$ side lengths}\DIFaddend , more than one triangle can be drawn.
...
\noindent
\textbf{Tags:} {\footnotesize Constructing triangles, CC.7.G.A.2}\\
\textbf{Version:} \DIFdelbegin \DIFdel{37208764..}\DIFdelend \DIFaddbegin \DIFadd{f333944c.. }\DIFaddend 2013-10-18
\smallskip\hrule
...
We have $2$ $\blue{45^\circ}$ angles. \DIFdelbegin \DIFdel{Since $\pink{180^\circ}-2\cdot\blue{45^\circ}=\blue{90^\circ}$, the missing angle }\DIFdelend \DIFaddbegin \DIFadd{The third angle $x$ }\DIFaddend is $\blue{90^\circ}$\DIFdelbegin \DIFdel{. We have }\DIFdelend \DIFaddbegin \DIFadd{: 
}

\begin{align*}\DIFadd{ \pink{180^\circ}}&\DIFadd{= 2\cdot\blue{45^\circ} + x }\\ \DIFadd{\pink{180^\circ}}&\DIFadd{= \blue{90^\circ} + x }\\
\DIFadd{x }&\DIFadd{= \pink{180^\circ}-\blue{90^\circ} }\\
\DIFadd{x }&\DIFadd{= \blue{90^\circ} }\end{align*}

\DIFadd{Let's draw }\DIFaddend a right triangle. 

\paragraph{Hint 2}We \DIFdelbegin \DIFdel{know a length and $2$ angles. We }\DIFdelend can draw a triangle given the side length $\blue2$ is not between the $2$ $\blue{45^\circ}$ angles. The side length $\blue2$ is between the $\blue{45^\circ}$ and $\blue{90^\circ}$ angles\DIFdelbegin \DIFdel{:
...
\noindent
\textbf{Tags:} {\footnotesize Constructing triangles, CC.7.G.A.2}\\
\textbf{Version:} \DIFdelbegin \DIFdel{4890bf29}\DIFdelend \DIFaddbegin \DIFadd{dc27e435}\DIFaddend .. 2013-10-18
\smallskip\hrule
...
\paragraph{Hint 1}A triangle is a plane figure with $3$ straight sides and $3$ angles. Can we satisfy the definition given the conditions? Let's try to draw a triangle where we known the \DIFdelbegin \DIFdel{lengths }\DIFdelend \DIFaddbegin \DIFadd{measures }\DIFaddend of all $3$ angles. \DIFdelbegin 
\paragraph{\DIFdel{Hint 2}}\addtocounter{paragraph}{-1}\DIFdelend For example, let's look at when all $3$ angles are $\blue{60^\circ}$\DIFdelbegin \DIFdel{:
}\DIFdelend \DIFaddbegin \DIFadd{.
}\DIFaddend 

\DIFdelbegin 
\DIFdelend \DIFaddbegin \paragraph{\DIFadd{Hint 2}}\DIFaddend Is this triangle unique, meaning do no other triangles exist with exact same shape or size?


\DIFaddbegin \includegraphics[scale=\shrinkfactor]{figures/9bbd0fa30a5ae16d50c816c4a8c4cfc44a68146c.png}

\DIFaddend \paragraph{Hint 3}We can draw many equilateral triangles with same shape but different sizes\DIFdelbegin \DIFdel{:
}\DIFdelend \DIFaddbegin \DIFadd{.
}\DIFaddend 
...
\noindent
\textbf{Tags:} {\footnotesize Constructing triangles, CC.7.G.A.2}\\
\textbf{Version:} \DIFdelbegin \DIFdel{a46c4b72}\DIFdelend \DIFaddbegin \DIFadd{30ec1d68}\DIFaddend .. 2013-10-18
\smallskip\hrule
...
\noindent
\textbf{Tags:} {\footnotesize Constructing triangles, CC.7.G.A.2}\\
\textbf{Version:} \DIFdelbegin \DIFdel{5f43d2fc.. 2013-10-17
}\DIFdelend \DIFaddbegin \DIFadd{3bc9edc0.. 2013-10-18
...
\noindent
**Draw \DIFdelbegin \DIFdel{a scalene }\DIFdelend \DIFaddbegin \DIFadd{an obtuse }\DIFaddend triangle with angles $45^\circ$,  \DIFdelbegin \DIFdel{$60^\circ$ and $75^\circ$}\DIFdelend \DIFaddbegin \DIFadd{$35^\circ$ and $100^\circ$}\DIFaddend .**
...
For example, while keeping a \DIFdelbegin \DIFdel{$\blue{60^\circ}$ }\DIFdelend \DIFaddbegin \DIFadd{$\blue{45^\circ}$ }\DIFaddend angle, we can change the side lengths to create the \DIFdelbegin \DIFdel{$\blue{45^\circ}$ }\DIFdelend \DIFaddbegin \DIFadd{$\blue{35^\circ}$ }\DIFaddend angle. The final angle will be \DIFdelbegin \DIFdel{$\blue{75^\circ}$}\DIFdelend \DIFaddbegin \DIFadd{$\blue{100^\circ}$}\DIFaddend .
...
\DIFdelbegin \DIFdelend \DIFaddbegin \includegraphics[scale=\shrinkfactor]{figures/c6b48cf353062cc42130d16552b68f58a6daf58e.png}
\DIFaddend 
...
\noindent
\textbf{Tags:} {\footnotesize Constructing triangles, CC.7.G.A.2}\\
\textbf{Version:} \DIFdelbegin \DIFdel{5ef1e69a}\DIFdelend \DIFaddbegin \DIFadd{040283a2}\DIFaddend .. 2013-10-18
\smallskip\hrule
...
\paragraph{Hint 1}\DIFaddbegin \DIFadd{A triangle is a plane figure with $3$ straight sides and $3$ angles. The $3$ angles always add up to $\pink{180^\circ}$. Let's add together the angles $\blue{30}^\circ$,  $\blue{50}^\circ$ and $\blue{100}^\circ$:
}


\DIFadd{So, at least $1$ triangle exists. Let's start by drawing.
}

\paragraph{\DIFadd{Hint 2}}\DIFaddend We know the measure of $3$ angles but not the length of any side. We can draw many triangles with the same shape but different \DIFdelbegin \DIFdel{size}\DIFdelend \DIFaddbegin \DIFadd{sizes}\DIFaddend .


\DIFdelbegin \paragraph{\DIFdel{Hint 2}}
\addtocounter{paragraph}{-1}\DIFdelend \includegraphics[scale=\shrinkfactor]{figures/cfa8c2afddab68081b192038f3130d47880b443e.png}

\includegraphics[scale=\shrinkfactor]{figures/b1683148f0f59becb3f7ee5221cd130e632609d7.png}

\paragraph{Hint 3}If \DIFaddbegin \DIFadd{only }\DIFaddend the measures of all $3$ angles are known, more than one triangle can be drawn.
...
\noindent
\textbf{Tags:} {\footnotesize Constructing triangles, CC.7.G.A.2}\\
\textbf{Version:} \DIFdelbegin \DIFdel{a599ba59}\DIFdelend \DIFaddbegin \DIFadd{99af1276}\DIFaddend .. 2013-10-18
\smallskip\hrule
