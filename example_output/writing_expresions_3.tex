...
\noindent
A company has fixed monthly **revenues** of $1000$ dollars and variable monthly **costs**. 

The company’s profits are equal to the revenues minus the costs.
If in a given month the company had costs of $c$ dollars, **write an expression which describes the company’s monthly profits.**
...
\noindent
\textbf{Tags:} {\footnotesize SB.6.1.E.2.CR, Writing expressions 1, Expressions in word problems, CC.6.EE.A.2}\\
\textbf{Version:} 889088bd.. 2013-06-22
\smallskip\hrule
