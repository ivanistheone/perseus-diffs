...
\paragraph{Ans} Option 1 offers a \DIFdelbegin \DIFdel{total }\DIFdelend pizza area of  [[? input-number 1]]$\text{ in}^2$  while Option 2 offers \DIFdelbegin \DIFdel{an }\DIFdelend \DIFaddbegin \DIFadd{a total pizza }\DIFaddend area of [[? input-number 2]]$\text{ in}^2$, so [[? dropdown 1]] has a lower price per square inch.  314.1592653589793

\paragraph{Hint 1}Let's use the area formula $\purple{A}=\pi \red{r}^2$ to find the area of pizza for the two deals.

\paragraph{Hint 2}For Option \DIFdelbegin \DIFdel{1}\DIFdelend \DIFaddbegin \DIFadd{$1$}\DIFaddend , the total area of pizza is equal to the area of the extra-large pizza 
...
\paragraph{Hint 4}Option 1 offers \DIFdelbegin \DIFdel{a total pizza area of $ 100\pi \text{ in}^2$ while the }\DIFdelend \DIFaddbegin \DIFadd{$100\pi \text{ in}^2$ of pizza while the total pizza }\DIFaddend area of Option 2 is $\frac{225}{2}\pi\text{ in}^2$.

Since $\frac{225}{2} > 100$, \DIFdelbegin \DIFdel{**Option 2** }\DIFdelend \DIFaddbegin \DIFadd{Option 2 }\DIFaddend has a lower price per square inch of pizza.
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, SB.7.1.F.2.SR, Area and circumference of a circle.circle area}\\
\textbf{Version:} \DIFdelbegin \DIFdel{0ae227ad}\DIFdelend \DIFaddbegin \DIFadd{e05419c3}\DIFaddend .. 2013-10-16
\smallskip\hrule
...
\noindent
\DIFdelbegin \DIFdel{If }\DIFdelend \DIFaddbegin \DIFadd{When }\DIFaddend the radius of a circle is multiplied by a factor of $3$, by what factor will the area of the circle increase?

\paragraph{Ans} \DIFaddbegin \DIFadd{**Complete the sentence.**
}
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, SB.7.1.F.2.SR, Area and circumference of a circle.circle area}\\
\textbf{Version:} \DIFdelbegin \DIFdel{7c11a267.. 2013-10-11
}\DIFdelend \DIFaddbegin \DIFadd{c2f633d7.. 2013-10-16
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, SB.7.1.F.2.SR, Area and circumference of a circle.circle area}\\
\textbf{Version:} \DIFdelbegin \DIFdel{a3412e12.. 2013-10-09
}\DIFdelend \DIFaddbegin \DIFadd{2317e8db.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\DIFdelbegin \DIFdel{The ratio of the circle's circumference to the circle's diameter is therefore  
}
\DIFdel{$\qquad \dfrac{\blue{C}}{\green{d}}=\pi$. 
}
\DIFdelend \paragraph{Hint 3}\DIFdelbegin \DIFdel{In fact, this is how the number $\pi$ is defined.
}\DIFdelend The number $\pi = 3.14159265\ldots$ is defined as the ratio between the circumference and the diameter of *any* \DIFdelbegin \DIFdel{circle**.
**
 }\DIFdelend \DIFaddbegin \DIFadd{circle.
}\DIFaddend 

\DIFaddbegin \paragraph{\DIFadd{Hint 4}}\DIFadd{The ratio of the circle's circumference to the circle's diameter is
}
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, SB.7.1.F.2.SR, Area and circumference of a circle.Circle circumference}\\
\textbf{Version:} \DIFdelbegin \DIFdel{eca247ba.. 2013-10-09
}\DIFdelend \DIFaddbegin \DIFadd{05e41bd9.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\noindent
\DIFdelbegin \DIFdel{If }\DIFdelend \DIFaddbegin \DIFadd{When }\DIFaddend the radius of a circle is multiplied by a factor of $3$, by what factor will the circumference of the circle increase?
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, SB.7.1.F.2.SR, Area and circumference of a circle.Circle circumference}\\
\textbf{Version:} \DIFdelbegin \DIFdel{f6452a4a.. 2013-10-11
}\DIFdelend \DIFaddbegin \DIFadd{e379067e.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
The number $\pi = 3.14159265\ldots$ is defined as the constant of proportionality which relates the circle's diameter to its \DIFdelbegin \DIFdel{circumference**.
**
 }\DIFdelend \DIFaddbegin \DIFadd{circumference.
}\DIFaddend 

\DIFaddbegin \paragraph{\DIFadd{Hint 4}}\DIFadd{The constant of proportionality between the circumference and the diameter of a circle is $\pi$.
}
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, SB.7.1.F.2.SR, Area and circumference of a circle.Circle circumference}\\
\textbf{Version:} \DIFdelbegin \DIFdel{a1c044c5.. 2013-09-30
}\DIFdelend \DIFaddbegin \DIFadd{0703abb2.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\noindent
The figure below shows two ropes that circle around the Earth. \DIFdelbegin \DIFdel{The $\red{\text{red}}$ rope }\DIFdelend \DIFaddbegin \DIFadd{Rope $\red{\text{A}}$ }\DIFaddend hugs the surface of the Earth. \DIFdelbegin \DIFdel{The $\purple{\text{purple}}$ rope }\DIFdelend \DIFaddbegin \DIFadd{Rope $\purple{\text{B}}$ }\DIFaddend lies $1\text{ m}$ above the surface of the Earth.
...
\paragraph{Hint 2}The circumference of \DIFdelbegin \DIFdel{the $\red{\text{red}}$ rope }\DIFdelend \DIFaddbegin \DIFadd{rope $\red{\text{A}}$ }\DIFaddend is 

\DIFdelbegin \DIFdel{$\qquad \red{C_1}=2\pi r =2\pi R$}\DIFdelend \DIFaddbegin \DIFadd{$\qquad \red{C_A}=2\pi r =2\pi R$}\DIFaddend .

\paragraph{Hint 3}The circumference of \DIFdelbegin \DIFdel{the $\purple{\text{purple}}$ rope }\DIFdelend \DIFaddbegin \DIFadd{rope $\purple{\text{B}}$ }\DIFaddend is

\DIFdelbegin \DIFdel{$\qquad \purple{C_2}=2\pi r =2\pi (R+1)$}\DIFdelend \DIFaddbegin \DIFadd{$\qquad \purple{C_B}=2\pi r =2\pi (R+1)$}\DIFaddend .
...
\qquad  d 
}& \DIFdel{= \purple{C_2} - \red{C_1} }\\
&\DIFdel{= 2\pi (R+1) \ - \ 2\pi R  }\\
&\DIFdel{= \cancel{2\pi R} + 2\pi \ \cancel{- \ 2\pi R} }\\
& \DIFdel{= 2\pi
}\end{eqnarray*} 
\DIFdelend \DIFaddbegin \begin{align*}\DIFadd{
\qquad  d 
}& \DIFadd{= \purple{C_B} - \red{C_A} }\\
&\DIFadd{= 2\pi (R+1) \ - \ 2\pi R  }\\
&\DIFadd{= \cancel{2\pi R} + 2\pi \ \cancel{- \ 2\pi R} }\\
& \DIFadd{= 2\pi
}\end{align*} 
\DIFaddend 
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, SB.7.1.F.2.SR, Area and circumference of a circle.Circle circumference}\\
\textbf{Version:} \DIFdelbegin \DIFdel{3e3fbdae.. 2013-10-11
}\DIFdelend \DIFaddbegin \DIFadd{2be5068b.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\paragraph{Hint 1}The table is made up of a rectangular part and a \DIFdelbegin \DIFdel{circular part }\DIFdelend \DIFaddbegin \DIFadd{round part which is a half circle}\DIFaddend .

We want to find the perimeter of the table. 

Imagine a small insect which walks along the edge of the table. \DIFdelbegin \DIFdel{What distance will the insect travel if it makes }\DIFdelend \DIFaddbegin \DIFadd{The perimeter of the table is how long the insect will have to travel to make }\DIFaddend a full turn around the table\DIFdelbegin \DIFdel{and comes back to the point where it started from? 
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, Area and circumference of a circle.Composite region calculations, SB.7.1.F.2.SR}\\
\textbf{Version:} \DIFdelbegin \DIFdel{85b3454c.. 2013-10-11
}\DIFdelend \DIFaddbegin \DIFadd{13ec1447.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, Area and circumference of a circle.Composite region calculations, SB.7.1.F.2.SR}\\
\textbf{Version:} \DIFdelbegin \DIFdel{0093daff.. 2013-10-09
}\DIFdelend \DIFaddbegin \DIFadd{67d87d45.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\paragraph{Hint 3}The circular part of the table has the shape of a half-circle with diameter $\red{d}=\red{2}\text{ m}$. If the diameter of a circle is $\red{d}=\red{2}\text{ m}$ then its radius is $\green{r}=\green{1}\text{ m}$ and its area is \DIFdelbegin \DIFdel{$A=\pi \green{r}^2=\pi\text{ m}^2$}\DIFdelend \DIFaddbegin \DIFadd{$A_{\text{circ}}=\pi \green{r}^2=\pi\text{ m}^2$}\DIFaddend .

The area of the circular part of the table is equal to $\purple{\text{half}}$ of the area of the full circle:

\DIFdelbegin \DIFdel{$\qquad A 
= \purple{\dfrac{1}{2}}\pi\green{r}^2
= \purple{\dfrac{1}{2}}\pi(\green{1})^2
= \dfrac{\pi}{2}\text{ m}^2 $
}\DIFdelend \DIFaddbegin \DIFadd{$\qquad A 
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, Area and circumference of a circle.Composite region calculations, SB.7.1.F.2.SR}\\
\textbf{Version:} \DIFdelbegin \DIFdel{cc261381.. 2013-10-09
}\DIFdelend \DIFaddbegin \DIFadd{525ff49e.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, Area and circumference of a circle.Composite region calculations, SB.7.1.F.2.SR}\\
\textbf{Version:} \DIFdelbegin \DIFdel{6154c60c.. 2013-10-09
}\DIFdelend \DIFaddbegin \DIFadd{7cff8e97.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\paragraph{Hint 3}The \DIFdelbegin \DIFdel{circular regions are quarters of a }\DIFdelend \DIFaddbegin \DIFadd{circumference of a whole circle is $2\pi\purple{r}$. The radius of the circular regions is $\red{r}=\red{4}$. The circumference of a full circle of that size would be $2\pi\purple{r}=2\pi (\purple{4})=8\pi$.
 }

\DIFadd{The circular regions are quarters of a }\DIFaddend circle.  The \DIFdelbegin \DIFdel{circumference of a whole circleis $2\pi\purple{r}$. The }\DIFdelend length of a quarter circle is equal to $\frac{1}{4}$ of \DIFdelbegin \DIFdel{$2\pi \purple{r}$}\DIFdelend \DIFaddbegin \DIFadd{the circumference of the full circle, so the length of each quarter circle is $\frac{1}{4}8\pi=2\pi$}\DIFaddend .

\DIFdelbegin \DIFdel{The radius of the circular regions is $\red{r}=\red{4}$ and there }\DIFdelend \DIFaddbegin \DIFadd{There }\DIFaddend are $\green{2}$ of these quarters-circles \DIFdelbegin \DIFdel{.
Their }\DIFdelend \DIFaddbegin \DIFadd{so the }\DIFaddend combined length of the circular parts \DIFaddbegin \DIFadd{of the perimeter }\DIFaddend is 

\DIFdelbegin \begin{eqnarray*}\DIFdel{
\qquad \blue{P_2} 
}&\DIFdel{= \green{2} \times \left(\frac{1}{4}2\pi \purple{r}\right)  }\\[2mm]
 &\DIFdel{= \green{2} \times \left(\frac{1}{4}2\pi (\purple{4})\right)  }\\[2mm]
 &\DIFdel{= \green{2} \times \left(\frac{1}{\cancel{4}}2\pi (\cancel{4})\right)  }\\[2mm]
&\DIFdel{= \blue{4\pi}\text{ m}.
}\end{eqnarray*}
\DIFdelend \DIFaddbegin \begin{align*}\DIFadd{
\qquad \blue{P_2} 
}&\DIFadd{= \green{2} \cdot 2\pi = \blue{4\pi}\text{ m}.
}\end{align*}
\DIFaddend 
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, Area and circumference of a circle.Composite region calculations, SB.7.1.F.2.SR}\\
\textbf{Version:} \DIFdelbegin \DIFdel{b8a0a78a.. 2013-10-13
}\DIFdelend \DIFaddbegin \DIFadd{96fe45b8.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\textbf{Version:} \DIFdelbegin \DIFdel{01b2fbf2.. 2013-10-15
}\DIFdelend \DIFaddbegin \DIFadd{aff1c780.. 2013-10-16
}\DIFaddend \smallskip\hrule
...
\noindent
Lucy wants to calculate the area of a $14\text{ in}$ pizza, but she forgot the formula for the area of a circle. She decides to cut the pizza into slices and rearrange the slices so that half the slices point downward and half point upward to form a parallelogram. Since the pizza-circle and the pizza-parallelogram are made up of the same slices, \DIFdelbegin \DIFdel{the area of the pizza is the same as the areaof the parallelogram}\DIFdelend \DIFaddbegin \DIFadd{they have the same area}\DIFaddend .
...
The length of the base of the parallelogram is \DIFaddbegin \DIFadd{approximately }\DIFaddend equal to half of the circumference of the pizza $b=\frac{C}{2}=$  [[? input-number 2]]$\text{ in}$.  
...
\noindent
\textbf{Tags:} {\footnotesize CC.7.G.B.4, SB.7.1.F.2.SR, Area and circumference of a circle.derive A formula from C formula}\\
\textbf{Version:} \DIFdelbegin \DIFdel{3afa31d4.. 2013-10-15
}\DIFdelend \DIFaddbegin \DIFadd{8f8d186f.. 2013-10-16
}\DIFaddend \smallskip\hrule
